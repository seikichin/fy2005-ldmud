...
void do_prime_2(object powderi,object bulleti,object into_powderi,object into_bulleti)
{
	...
	into_powderi = clone_object("/d/chengdu/obj/gun_powder.c");
	into_powderi->set_amount(3);
  into_powderi->move(this_object());
	into_bulleti = clone_object("/d/chengdu/obj/iron_bullet.c");
...
void do_fishing(object me, object bait)
{
   ...
   switch (random(3)) {
      ...
      case 2:
         ...
         fish = clone_object(__DIR__"obj/fish");
         fish->move(me);
         destruct(bait);
         break;
      }
...
void do_fire2(object me,object ob,object *inv,object powderi,object bulleti)
{
  ...
  ob->kill_ob(me); 
	...
	powder_dusti = clone_object("/d/chengdu/obj/powder_dust.c");
