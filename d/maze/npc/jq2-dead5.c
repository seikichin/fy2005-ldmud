...
void create()
{
        set_name("兴国高僧", ({ "prisoner"}) );
        set("gender", "男性" );
        set("title",WHT"走肉"NOR);
        set("age", 52);
	set("long","曾几何时，他们还是江湖上头可断、血可流，志不可没的铮铮汉子，可是地牢中\n"
"多年的折磨和药物的毒害，已经把他们变成了没有神志、没有正邪的嗜血狂人。\n");
	...
	auto_npc_setup("liaoyin",180,170,1,"/obj/weapon/","fighter_w","cloudstaff",1);
	setup();
