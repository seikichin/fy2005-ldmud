...
"方还有一个圆形树疤。\n",
"一株枯死的古柏，躯体以顺时针方向拧扭盘旋而上，纹理清晰，质感细腻，\n"
"尤为奇特。\n",
"一棵古柏独立阶下，传说是唐代忠臣安金藏的化身。据传安金藏的魂魄曾来\n"
"泰山神前告武则天灭子之状，化为此柏，故名“孤忠柏”。\n",
...
"娘和眼光奶奶。可是自从西方神教崛起之后，这里就成了神教的一处分坛，来往泰\n"
"山岱庙的人，无不在此受到盘查。空空的大殿里神像已经破落，殿中有一案桌，桌\n"
"上是一幅打开的画。\n"
);
  	set("exits",([
        	 "west":__DIR__"yaocan",
...
int do_look(string arg){
	int num;
	if (arg=="picture" || arg == "画") {
		num = query("pswd");
		write("这是一幅岱庙的风景画，手笔很是潦草，似乎匆匆画成：\n"
		+scene_des[num]+"\n");
		return 1;
	}
	return 0;
