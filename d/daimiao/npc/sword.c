...
{
	object weapon;
	set_name("一剑万生", ({ "wansheng","wan sheng" }) );
...
//		(: auto_smart_fight(100) :),
	...
	weapon->set_name(HIB"百禽魂"NOR, ({ "sword"}) );
	weapon->set("long","\n");
	weapon->set("value",0);
	weapon->wield();
...
pf(object tm)
{
	...
	message_vision(MAG"$N与$n微微发颤的手引着双色的流光画出一个又一个完整的圆弧，一起一伏中隐含着奇特的韵律，\n",me,tm);
