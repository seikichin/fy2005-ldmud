...
void create()
{
	...
	set("long","这是条青条石砌成的小巷，比起吉祥镇的小街宽敞了不少，倒也还算平整，路\n"
"旁两排[37m楠木树[32m修剪地整整齐齐，时不时还有几辆四轮的马车沿路飞快的冲入巷子。\n");
	set("outdoors", "fugui");
	set("type","road");
	set("exits",([
...
int do_climb (string arg)
{
	...
	if (move < 40)
		return notify_fail("树太高了，你爬不上去。（需40级轻功）\n");
