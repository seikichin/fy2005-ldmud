...
void create()
{
	...
	set("long","万丈绝壑下，是一片无边无际的沼泽，没有树木、没有花草、没有生命！有的\n"
...
void do_moving(object me)
{
	...
	message_vision(HIR"突然，$N的头撞到了什么硬物，$N觉得脑中一阵晕眩．．\n"NOR,me);
	me->unconcious();
	room = find_object(__DIR__"mudedge");
	if(!objectp(room)) room= load_object(__DIR__"mudedge");
	me->move(room);
}
