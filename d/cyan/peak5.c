...
void wake(object me,object obj)
{
	...
	oe=clone_object("/d/phoenix/npc/cyan_player");
	oe->move(obj);
...
//	"/cmds/imm/full"->main(oe);
	...
	oc=clone_object("/d/phoenix/cyan/npc/ruo");
	oc->move(obj);
...
void waked2(object me,object obj)
{
	...
	oe=clone_object("/d/phoenix/npc/cyan3_player");
	oe->move(obj);
...
//	"/cmds/imm/full"->main(oe);
	...
	oc=clone_object("/d/phoenix/cyan3/npc/feng");
	oc->move(obj);

	oc=clone_object("/d/phoenix/cyan3/obj/corpse");
	oc->set("name","华山门下的尸体");
	oc->move(obj);
	oc=clone_object("/d/phoenix/cyan3/obj/corpse");
	oc->set("name","华山门下的尸体");
