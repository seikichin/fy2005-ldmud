...
{
	set("short", "三清宫");
	set("long","两扇铜钉大门紧紧关着，门的上方挂着一块金匾，匾上龙飞凤舞地写着＂三清\n"
...
void wantopen(object me)
{
    ...
    if(present("taoist fighter", this_object())){
   	...
   	waiter = clone_object(__DIR__"npc/waiter_taoist");
...
int do_knock(string arg)
{
	object room, me, thisroom;
    	...
    	set("long","铜钉大门敞开着，门的上方挂着一块金匾，匾上龙飞凤舞地写着＂三清宫＂\n"
...
void closedoor(object me)
{
	...
	troom = this_object();
		...
		delete("exits/north");
    	set("long","两扇铜钉大门紧紧关着，门的上方挂着一块金匾，匾上龙飞凤舞地写着＂三\n"
