...
{
        set("short", "北街尽头");
        set("long","小镇的繁华很快就在此截然中止，向前望又是草原，无边无际。不时有几骑快\n"
...
int do_enter(string arg){
	...
	cart=clone_object(__DIR__"npc/obj/carriage");
    cart->move(this_object());
	    	
    chefu=clone_object(__DIR__"npc/chefu");
    chefu->move(ob);
	...
	set("mark/rented",1);
	set("long","小镇的繁华很快就在此截然中止，向前望又是荒原，无边无际。不时有几骑快\n"
