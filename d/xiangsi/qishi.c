...
{
	set("short", "奇石疏影");
	set("long","沿着道路又行了片刻，你忽然惊觉附近的景色竟与记忆中大不相同。凝目\n"
...
void greeting(object ob)
{
	...
	if (value >= 20000 && value < 100000)		// 穷土匪	20K Exp
		robber=clone_object(__DIR__"npc/bandit");
	else if (value >= 100000 && value < 250000)	// 风颜		1M Exp
		robber=clone_object(__DIR__"npc/fonyan");
	else if (value >= 250000)					// 风满楼	7M Exp
		robber=clone_object(__DIR__"npc/fonmanlou");
