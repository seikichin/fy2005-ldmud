...
void trigger(object me)
{
	...
	message_vision(CYN"苏若瞅著你银铃般轻笑：我的大少爷，你可算醒了，大家寻你寻得焦头烂额，你倒是藏在这里好一顿饱觉啊。\n",me);
	message_vision(CYN"苏若说道：穆坛主可是找你半天了呢。喏，用这水洗一把脸，然后还是快点过去吧，可莫要拖得惹他老人家生气才好。\n",me);
	message_vision(CYN"苏若给你一个大肚瓶，扮了个鬼脸飘然而去。\n",me);
