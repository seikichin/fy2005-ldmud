...
tell_room(this_object(),HIW"\n明霞守备长忧心忡忡地自垛口向外望了一眼：没想到今天贼寇趁狂风来犯，我\n们又要让人上瞭望台转动风弩，又要留着人在这里守住机括，人手不够呀！\n守军甲说道：官长放心，今天俺就算拼了性命不要，也绝不让那些贼寇马踏\n中原！\n"NOR);
tell_room(this_object(),HIW"守军乙用力地拍着你的背道：老"+me->query("name")[0..1]+"，今天可就看咱的了！\n\n"NOR);
...
void failed()
{
	...
	if (!query("a"))
	{
	CHANNEL_D->do_channel(this_object(), "chat", HIC+query("ownerr")+"没能够在倭人面前守住中原．．．"+NOR,1);
	set("a",1);
		}
