...
{
        set("short", "青草地");
        set("long","走过来是郁郁葱葱的青草地，草很绿，很齐，像是日常有人修剪。草丛里这儿\n"
"那儿盛开着簇簇的野花，走过的人便走在一阵淡淡的花香中，不时还会惊起几只蚱\n"
"蜢，一蹦一蹦地跳远。草地边有两间小屋。\n"
""
        );
        set("exits", ([ 
	"southwest" : __DIR__"groad2a",
	"north" : __DIR__"dazuiju1",
	"east" : __DIR__"groad3",
	]));
        set("objects", ([
	]) );
...
void dig_notify()
{
     	...
     	if (!random(5))	worm = clone_object(__DIR__"obj/redworm");
        	else worm=clone_object(__DIR__"obj/worm");
