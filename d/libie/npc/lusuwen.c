...
"青龙会更庞大严密的组织。 \n",
	...
	set("long","一身素衣，打点的干干净净，无情的岁月在一张本是清秀动人的面庞上\n"
"留下了些许苍老与疲倦。\n"
""
...
"微风在轻轻叹息，窗外飞过的雀儿在低低啁啾，一切归于宁寂。。。\n\n\n"NOR,lu);
			sheet = clone_object(__DIR__"obj/sheet");
...
{	object me,corpse,*inv,room;
	...
	corpse=clone_object("/d/libie/obj/lucorpse");
	corpse->move(room);
...
"吕素文微叹一声，转入屋后。\n"NOR);
	...
	sword = clone_object(__DIR__"obj/leavehook");
	if (sword)	
