...
int do_activate(string arg)
{
		...
		if (!arg || arg != "qingxin music"){
			tell_object(me,"格式：activate qingxin music\n");
			return 1;
		}
		...
		tell_object(me, "你苦苦揣摩，终于背出了清心普善曲，可惜用脑过度，原来学的都忘了。\n")	;	
		
        me->set("annie/music_choose",4);
