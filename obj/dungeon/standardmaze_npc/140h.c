...
{
	object weapon;
        set_name("应平生", ({ "ying pingsheng","ying","pingsheng" }) );
        set("title",WHT"圆转无相生"NOR);
		set("nickname",MAG"道道非非不可尽"NOR);
        set("gender", "男性" );
		set("class","wudang");
...
//		set_temp("apply/haste",200);
        ...
        weapon->set_name("至尊法衣", ({ "cloth" }) );
		weapon->set("long","");
		weapon->set("value",0);
		weapon->wear();

		weapon=carry_object("/obj/weapon/sword");
		weapon->set_name("封山剑", ({"sword" }) );
		weapon->set("long","");
		weapon->set("value",0);
//		weapon->wield();
}
