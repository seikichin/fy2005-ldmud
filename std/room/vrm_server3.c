...
#define BOX_OB          "/obj/wiz_toy/baoxiang1"
#define TRAP_ROOM       "/std/room/trap"
...
struct coordinate *newpath = ({});
struct coordinate *badpath = ({});
struct coordinate *roadpath = ({});
...
// 选择随机出口.
protected varargs int random_out(int x,int y,int n,int t);
...
{
        int i, x, y, exits;
        struct coordinate temp, *valid_leaves = ({});
...
void init_road()
{
        ...
        int x, y, out, numb;
        struct coordinate *valid_leaves = ({});
