...
int main(object me, string arg)
{
	...
	input_to("get_msg_myself",INPUT_PROMPT,"",emote,arg);
	return 1;
}
...
int get_msg_myself(string msg, mapping emote, string pattern)
{
	if (msg==".") {
		...
		input_to("get_msg_others",INPUT_PROMPT,"", emote, pattern);
		return 1;
	}
	if( !undefinedp(emote["myself"]) )
		emote["myself"] += msg + "\n";
	...
	write("->");
	input_to("get_msg_myself",INPUT_PROMPT,"", emote, pattern);
	return 1;
}
...
int get_msg_others(string msg, mapping emote, string pattern)
{
	if (msg==".") {
		...
		input_to("get_msg_myself_self", 4,emote, pattern);
		return 1;
	}
	if( !undefinedp(emote["others"]) )
		emote["others"] += msg + "\n";
	...
	write("->");
	input_to("get_msg_others", 4,emote, pattern);
	return 1;
}
...
int get_msg_myself_self(string msg, mapping emote, string pattern)
{
	if (msg==".") {
		...
		input_to("get_msg_others_self", 4,emote, pattern);
		return 1;
	}
	if( !undefinedp(emote["myself_self"]) )
...
int get_msg_others_self(string msg, mapping emote, string pattern)
{
	if (msg==".") {
		...
		input_to("get_msg_myself_target", 4,emote, pattern);
		return 1;
	}
	if( !undefinedp(emote["others_self"]) )
	...
	write("->");
	input_to("get_msg_others_self",INPUT_PROMPT,"", emote, pattern);
	return 1;
}
...
int get_msg_myself_target(string msg, mapping emote, string pattern)
{
	if (msg==".") {
		...
		input_to("get_msg_target", 4,emote, pattern);
		return 1;
	}
	if( !undefinedp(emote["myself_target"]) )
	...
	write("->");
	input_to("get_msg_myself_target",INPUT_PROMPT,"", emote, pattern);
	return 1;
}
...
int get_msg_target(string msg, mapping emote, string pattern)
{
	if (msg==".") {
		...
		input_to("get_msg_others_target",INPUT_PROMPT,"", emote, pattern);
		return 1;
	}
	if( !undefinedp(emote["target"]) )
		emote["target"] += msg + "\n";
	...
	write("->");
	input_to("get_msg_target",INPUT_PROMPT,"", emote, pattern);
	return 1;
}
