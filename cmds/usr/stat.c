...
int main(object me, string arg)
{
	...
	if( (!mappingp(buff_list) || !sizeof(buff_list))
		&& (!mappingp(cont_list) || !sizeof(cont_list))
		&& (!mappingp(vend_list) || !sizeof(vend_list)))
	{
	...
	if (mappingp(cont_list) && sizeof(cont_list))
	{
		write(HIR BLK"────────────────\n"NOR);
	...
	if (mappingp(vend_list) && sizeof(vend_list))
	{
		write(HIR BLK"────────────────\n"NOR);
