...
void add_day_event(int start_at, int length, object ob, closure event_function) {
...
void add_year_event(int month, int day, int length, object ob, closure event_function) {
