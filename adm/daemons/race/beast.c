// beast.c 野兽  
//     This file servers two functions:
//	(1) to be comparable with old NPCs, lots of them (insect/bird) still refers to this one.
//	(2) as a new defination file for the beast.
...
void create()
{
	...
	set("death_msg",       		"\n$N仰天惨嚎了一声，趴在地上不动了。\n"    );
	set("leave_msg",    		"奔了过去"				      );
	set("arrive_msg",     		"呼地窜了出来，警惕地四周张望着"              );
	set("fleeout_message",    	"惨叫一声，往$d落荒而逃"            );
	set("fleein_message",     	"慌慌张张地跑了过来，似乎后面有人追赶的样子"        );
