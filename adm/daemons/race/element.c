...
void setup_element(object ob)
{
	mapping my;
	my = ob->query_entire_dbase();

	//	元素inherently比正常多100倍气血。 it will mess with your own setting in file though :D
	if (!my["toughness"]) my["toughness"] = 10000;
	race_basic_setup(ob);
	...
	ob->set_temp("is_unconcious",1);	// 我要的是不攻击生物:p 其实这个类别应该是wall,不过silencer说要element...hmm,那就element bah	
}
