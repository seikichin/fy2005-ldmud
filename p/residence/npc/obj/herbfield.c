...
int do_water(string arg)
{
        ...
        if (query("last_irrigated") + 300 > time())
        {
                ...
                set("used",1);  // 需要清洁了
                herb = clone_object("/obj/medicine/herb_failed.c");
                herb->move(ob);
        ...
        if (query("last_irrigated")>1 && query("last_irrigated") + 900 < time())
        {
                ...
                set("last_irrigated",0);
                set("used",1);  // 需要清洁了
                herb = clone_object("/obj/medicine/cactus.c");
                herb->move(ob);
        ...
        case 3:
                ...
                {
                        case 129:
                                herb = clone_object("/obj/medicine/herb_f2.c");
                                req=9;
                                break;
                        case 247:
                                herb = clone_object("/obj/medicine/herb_f3.c");
                                req=8;
                                break;
                        case 832:
                                herb = clone_object("/obj/medicine/herb_e2.c");
                                req=7;
                                break;
                        case 571:
                                herb = clone_object("/obj/medicine/herb_d12.c");
                                req=6;
                                break;
                        case 768:
                                herb = clone_object("/obj/medicine/herb_d22.c");
                                req=5;
                                break;
                        case 496:
                                herb = clone_object("/obj/medicine/herb_d32.c");
                                req=4;
                                break;
                        case 985:
                                herb = clone_object("/obj/medicine/herb_e1.c");
                                req=3;
                                break;
                        case 613:
                                herb = clone_object("/obj/medicine/herb_c1.c");
                                req=2;
                                break;
                        case 354:
                                herb = clone_object("/obj/medicine/herb_c2.c");
                                req=1;
                                break;
                        default:
                                herb = clone_object("/obj/medicine/mushroom.c");
                                req=0;
                                break;
                }
