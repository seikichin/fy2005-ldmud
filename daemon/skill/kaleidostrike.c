...
int valid_learn(object me)
{
	...
	if( me->query_agi()  * 5 < me->query_skill("kaleidostrike",1) )
...
{
	return notify_fail("阿修罗冷秋无影手只能用学的。\n");
}
...
// 现存武器 kaleidostrike 
// /d/bashan/mazenpc/obj/wolfclaw
// /d/huashan/npc/obj/qingcong
// /d/xiangsi/mazenpc/obj/nail
...
mixed hit_ob(object me, object victim, int damage_bonus){	
	...
	if (wep != me->query_temp("left_hand"))
		return -800;
	if (wep->query("annie/for_kaleidostrike"))
	{
		t = random(me->query_skill("kaleidostrike",1));
		i = t / 100;
...
//		CHANNEL_D->do_sys_channel("sys",sprintf("ddd\n"));
