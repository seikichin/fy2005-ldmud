...
int perform(object me, object target, object friend)
{
	...
	int k;
	object you,ob;
	int skl_me, extra_me, skl_you,extra_you;
		
	if (userp(me) && me->query_skill("yiyangzhi",1)< 100)
		return notify_fail("一指定乾坤需要１００级一阳指法。\n");
	...
	if (!friend || friend == me) {
        msg = BBLU + HIY+"$N施展出刚阳的一阳指，"+ HIY +
        	"无数指影夹杂着炽热的指风，点向$n"HIY"的全身！\n\n" + NOR;
	...
	msg = BBLU+ HIR+"$N施展出刚阳的一阳指，"+ HIG + you->name()+"施展出阴柔的柔虹指，\n"+ HIY +"无数指影夹杂着阴冷炽热的指风，点向$n的全身！\n\n" + NOR;
