...
int conjure(object me, object target)
{
	...
	message_vision(YEL"$N悲啸一声，指取古劲，似千钧在握，又似一骑绝尘，万古同悲。挥拨之间，\n"
...
int summoning(object me) {
	...
	if (random(me->query_skill("music",1))> 5 ) {
		message_vision(RED"『广陵散』曲毕，天地之间寂然无声，似乎都已沉醉其中，募然，天地交接之\n"
"处宛如天唱般传来清啸一声，万里白云仿佛火烧一般，鲜红如血，一只硕大无\n"
"比的火鹤从天而降！\n\n"NOR,me);
			seteuid(getuid());
	        bird = clone_object("/obj/npc/fire_crane");
 		...
 		message_vision(WHT"募然“铮、铮”的数声，七弦尽断，你但觉生平凄苦伤心之事，历历在目，无\n"
